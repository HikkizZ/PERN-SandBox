...
import { DATABASE, BD_USERNAME, BD_PASSWORD, HOST } from "./configEnv.js";
...
export const AppDataSource = new DataSource({
    ...
    username: `${BD_USERNAME}`, // The username of the relational database
    password: `${BD_PASSWORD}`, // The password of the relational database
